...
export default function Hero({title}: HeroProps) {
    ...
    return (
        <section className="bg-karina-primary bg-[url('/images/bg.png')] bg-cover bg-inherit md:bg-center h-auto flex items-center justify-center">
             <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 p-6 lg:p-0">
                <div className="text-white flex flex-col justify-center gap-4 mt-24 lg:mt-0">
